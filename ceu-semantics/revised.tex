...
From the outer-step relation we define the reaction relation, which computes
a full program reaction.

\TODO{Definition ($\ostep\ast$), determinism, and termination}.
